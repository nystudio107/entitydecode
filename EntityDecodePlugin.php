...
class EntityDecodePlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Decodes HTML Entities');
    }
    ...
    {
        return 'https://github.com/nystudio107/entitydecode/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/nystudio107/entitydecode/master/releases.json';
    }
    ...
    {
        Craft::import('plugins.entitydecode.twigextensions.EntityDecodeTwigExtension');

        return new EntityDecodeTwigExtension();
    }
